...
//=================  GETTERS ===============
    ...
    public int getX(){
        return (int)(getAnimationGroup().getTranslateX() - (ViewManager.getWidth() / 2));
    }
    public int getY(){
        return (int)getAnimationGroup().getTranslateY();
    }

    public Rectangle2D getBounds(){
        return new Rectangle2D(getX(), getAnimationGroup().getTranslateY(),this.DIMENSIONS,this.DIMENSIONS);
    }
