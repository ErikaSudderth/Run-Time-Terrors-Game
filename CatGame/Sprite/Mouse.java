...
//        if(game.cat.getBounds().intersects(getBounds()) == true){
           System.out.println(game.cat.getX());
//        }
    }
...
//=================  GETTERS ===============
    ...
    public Rectangle2D getBounds(){
        return new Rectangle2D(this.animationGroup.getLayoutX(), this.animationGroup.getLayoutY(),this.DIMENSIONS,this.DIMENSIONS);
    }
